...
import com.balicodes.quicksms.data.dao.SendSmsDao
...
class SendSmsRepository(val app: Application) {
    ...
    fun loadByIdAsync(id: String): LiveData<SendSmsEntity> = sendSmsDao.loadByIdAsync(id)

    fun loadById(id: String) = sendSmsDao.loadById(id)
